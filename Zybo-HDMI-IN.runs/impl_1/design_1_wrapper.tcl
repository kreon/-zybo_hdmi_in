...
namespace eval ::optrace {
  variable script "C:/xil_prj/Zybo-HDMI-IN/Zybo-HDMI-IN.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/xil_prj/Zybo-HDMI-IN/Zybo-HDMI-IN.runs/synth_1/design_1_wrapper.dcp
